...
class RomanticEvents:
    ...
    def rebuild_dicts(cls):
        ...
        interaction_value_mod = ['increase','decrease']
        ...
        for val_type, dictionary in interactions.INTERACTION_MASTER_DICT.items():
            ...
            for modification in interaction_value_mod:
                cls.MATE_RELEVANT_INTERACTIONS[val_type][modification] = list(
                    filter(
        ...
        for val_type, dictionary in interactions.INTERACTION_MASTER_DICT.items():
            ...
            for modification in interaction_value_mod:
                ...
                if val_type == "romantic":
                    cls.ROMANTIC_RELEVANT_INTERACTIONS[val_type][modification] = dictionary[
                        modification
                    ]
                else:
                    cls.ROMANTIC_RELEVANT_INTERACTIONS[val_type][modification] = [
                        interaction
